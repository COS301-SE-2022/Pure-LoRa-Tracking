...
export class ThingsboardThingsboardTestsService {
  ...
  DeviceCredentialsExample = {
    ...
    credentialsId:
      'Access token or other value that depends on the credentials type',
    ...
    data: [
      {
        ...
        additionalInfo: {
          reserves: [
            { tenantID: '123', reserveID: 'aws', reserveName: 'losdj' },
          ],
        },
  ...
  axiosSensorKeysExample = {
    headers: {},
    config: {},
    status: 200,
    statusText: 'OK',
    data: ['longitude', 'latitude', 'fport', 'fcnt'],
  };
