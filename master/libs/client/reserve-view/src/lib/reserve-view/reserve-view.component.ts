...
export class ReserveViewComponent {
  ...
  ngOnInit(): void {
    //get the reserve
    this.apicaller.getReserve("eyJhbGciOiJIUzUxMiJ9..v0KSsiCZP1C7db00fXCgXESHIaMy14-yXb3IRzuf7Swe_EySfkq3nkrHfDUilsRywLa3-X4zVda2SPLi_sjnuw", "123").then(val => this.Reserve = val);
    this.apicaller.getHistorical("eyJhbGciOiJIUzUxMiJ9..v0KSsiCZP1C7db00fXCgXESHIaMy14-yXb3IRzuf7Swe_EySfkq3nkrHfDUilsRywLa3-X4zVda2SPLi_sjnuw","123",[]).then(val=>{
