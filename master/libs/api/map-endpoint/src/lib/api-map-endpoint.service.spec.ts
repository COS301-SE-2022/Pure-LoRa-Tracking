...
describe('ApiMapEndpointService', () => {
  ...
  //   console.log((await service.HistoricalProcess({deviceID:["b30f3f90-3d37-11ed-9f1a-879a3b706658"], pType:"PF", reserveID:"945bfd80-3d2e-11ed-9f1a-879a3b706658", token:(await login).Token, startTime:0, endTime:17000000000000})).data[0].locationData)
  // });
  ////////////////////////////////////////////////////////////////////////////////////
