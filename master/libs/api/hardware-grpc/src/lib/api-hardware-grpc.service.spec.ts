...
describe('ApiHardwareGrpcService', () => {
  ...
  describe('ApiHardwareGrpcService', () => {
    it('should return acknowledge interface', () => {
      ...
      jest
        .spyOn(eventMessages.StatusEvent, 'deserializeBinary')
  ...
  describe('deviceUpProcess', () => {
    it('should return', () => {
      ...
      jest
        .spyOn(eventMessages.UplinkEvent, 'deserializeBinary')
        .mockImplementation((content) => {
          expect(content).toBe(input);
          return device_data;
        });

      const calcLocation = jest
        .spyOn(locationService, 'calculateLocation')
        .mockImplementation();

      jest
        .spyOn(tbClientService, 'v1SendTelemetry')
        .mockImplementation(async (thingsBoardDeviceToken, dataJSON) => {
      ...
      expect(() => {
        service.deviceUpProcess(input);
      }).toThrow('Thingsboard device ID not set');
  ...
  describe('deviceJoinProcess', () => {
    it('should return acknowledge interface', () => {
      ...
      jest
        .spyOn(eventMessages.JoinEvent, 'deserializeBinary')
        .mockImplementation((content) => {
          expect(content).toBe(input);
          return device_data;
        });
  ...
  describe('deviceAckProcess', () => {
    it('should return acknowledge interface', () => {
      ...
      jest
        .spyOn(eventMessages.AckEvent, 'deserializeBinary')
        .mockImplementation((content) => {
          expect(content).toBe(input);
          return device_data;
        });
  ...
  describe('deviceErrorProcess', () => {
    it('should return acknowledge interface', () => {
      ...
      jest
        .spyOn(eventMessages.ErrorEvent, 'deserializeBinary')
        .mockImplementation((content) => {
          expect(content).toBe(input);
          return device_data;
        });
  ...
  describe('deviceTxackProcess', () => {
    it('should return acknowledge interface', () => {
      ...
      jest
        .spyOn(eventMessages.TxAckEvent, 'deserializeBinary')
        .mockImplementation((content) => {
          expect(content).toBe(input);
          return device_data;
        });
