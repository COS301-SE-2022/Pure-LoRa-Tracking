...
static const u1_t PROGMEM APPEUI[8] = { 0x2D, 0x13, 0xB2, 0x6C, 0xBE, 0x35, 0xE7, 0x00 };
// LSB mode
static const u1_t PROGMEM DEVEUI[8] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0xD5, 0xB3, 0x70 };
// MSB mode
...
static int joinStatus = EV_JOINED;
...
//    LMIC_setupChannel(0, 868100000, DR_RANGE_MAP(SF12, SF7), BAND_CENTI);      // g-band
    //    LMIC_setupChannel(1, 868300000, DR_RANGE_MAP(DR_SF12, DR_SF7B), BAND_CENTI);      // g-band
//    LMIC_setupChannel(1, 868100000, DR_RANGE_MAP(SF12, SF7), BAND_CENTI);      // g-band
//    LMIC_setupChannel(2, 868100000, DR_RANGE_MAP(SF12, SF7),  BAND_CENTI);      // g-band
...
//    for (int i = 3; i <= 8; i++ ) { //disable channels from 1 to 8
